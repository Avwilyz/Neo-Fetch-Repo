...
async def _(client, message):
    ...
    if len(args) < 2:
        await message.reply_text("contoh : .ytgold ZYuQf2uF")
        return
...
async def _(client, message):
    args = message.text.split(" ", 1)
    if len(args) < 2:
        await message.reply_text("contoh : .ytsilver ZYuQf2uF")
        return
...
async def _(client, message):
    args = message.text.split(" ", 1)
    if len(args) < 2:
        await message.reply_text("contoh : .iggold ZYuQf2uF")
        return
...
async def _(client, message):
    args = message.text.split(" ", 1)
    if len(args) < 2:
        await message.reply_text("contoh : .igsilver ZYuQf2uF")
        return
...
async def _(client, message):
    args = message.text.split(" ", 1)
    if len(args) < 2:
        await message.reply_text("contoh : .fbsilver ZYuQf2uF")
        return
...
async def _(client, message):
    args = message.text.split(" ", 1)
    if len(args) < 2:
        await message.reply_text("contoh : .fbgold ZYuQf2uF")
        return
...
async def _(client, message):
    args = message.text.split(" ", 1)
    if len(args) < 2:
        await message.reply_text("contoh : .twtsilver ZYuQf2uF")
        return
...
async def _(client, message):
    args = message.text.split(" ", 1)
    if len(args) < 2:
        await message.reply_text("contoh : .twtgold ZYuQf2uF")
        return
