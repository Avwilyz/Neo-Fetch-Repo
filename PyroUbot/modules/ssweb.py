...
async def screenshot_handler(client, message):
    ...
    await message.reply_text("<b><i>PROSES SS PAKAI PC NEO FETCH ♛</i></b>")
    ...
    await client.send_photo(message.chat.id, filepath, caption="**__Nih Neo Fetch Gambarnya Sudah Di Screenshot Pakai Pc.__**")
    os.remove(filepath)
