...
async def done_command(client, message):
    ...
    try:
        ...
        response = (
            ...
            f" <blockquote><b> ᴛᴇʀɪᴍᴀᴋᴀsɪʜ ᴛᴇʟᴀʜ ᴏʀᴅᴇʀ ᴅɪ <a href=tg://openmessage?user_id={OWNER_ID}>𝙿utra Gana 𝙲𝚘𝚛𝚙𝚘𝚛𝚊𝚝𝚒𝚘𝚗 ✮</a></blockquote"
            f" <blockquote>ᴛᴇsᴛɪᴍᴏɴɪ : <a href=https://t.me/nfstoreid>ᴄʟɪᴄᴋ</a> </blockquote>"
        )
        await izzy_ganteng.edit(response)
