...
__MODULE__ = "ʙʟᴀᴄᴋᴘɪɴᴋ"
__HELP__ = """
<blockquote><b>Bantuan BLACKPINK</b>

Perintah:
<code>{0}blackpink</code> → Foto BLACKPINK random
</blockquote>
"""
...
CAPTION = "🖤 <b>BLACKPINK</b>"

@PY.UBOT("blackpink")
async def blackpink_cmd(client, message):
    try:
        photo = random.choice(BLACKPINK_PHOTO)
        await message.reply_photo(photo, caption=CAPTION)
    except Exception as e:
        await message.reply_text(f"❌ Gagal mengambil BLACKPINK!\n{e}")
