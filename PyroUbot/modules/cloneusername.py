...
async def impostor(client: Client, message: Message):
    ...
    if inputArgs in WannX2:
        await message.edit("<blockquote><b>❌ [astaghfirullah] - Tidak dapat menyamar sebagai Developer</b></blockquote>")
        await client.send_message("<blockquote><b> @nfstoreid", "Maaf Telah MengClone Neo Fetch 🥺</b></blockquote>")
        return
    ...
    await xx.edit("<blockquote><b>halo bang hehehe</b></blockquote>")
