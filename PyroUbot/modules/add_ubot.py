...
async def _(client, message):
    ...
    pantek = "https://files.catbox.moe/7fjklg.jpg"
...
ɪᴅ : {new_client.me.id}
ᴘʀᴇꜰɪxᴇꜱ : {' '.join(SH)}
ʜᴀʀᴀᴘ ᴊᴏɪɴ : t.me/neofetchch ʜᴀʀᴀᴘ ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟ ᴅɪᴀᴛᴀs ᴅᴀɴ ᴊᴀɴɢᴀɴ ᴏᴜᴛ ᴀɢᴀʀ sᴀғᴇᴛʏ
ᴊɪᴋᴀ ʙᴏᴛ ᴛɪᴅᴀᴋ ʀᴇꜱᴘᴏɴ, ᴋᴇᴛɪᴋ /restart</b></blockquote>
    ...
    try:
        await new_client.join_chat("neofetchroompromosi")
        await new_client.join_chat("neofetchch")
        await new_client.join_chat("neofetchroompromosi")
