...
async def cekidte(client, message):
    ...
    msg = f"""
<blockquote><b>╭──「 🔍 NIH BRO DATA NYA 」</b>
│ 👤 <b>Nama Nya:</b> {name_link}
│ 🟢 <b>ID Nya:</b> <code>{target_user.id}</code> {digit_info}
│ 🔱 <b>Username:</b> {username_text}
│ 🏷️ <b>Data Nya:</b> <code>{target_user.dc_id or 'Tidak diketahui'}</code>
...
╰──「 <b>By @botcreateubot_bot</b> 」</blockquote>
"""
