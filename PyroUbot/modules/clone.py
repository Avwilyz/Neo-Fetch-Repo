...
async def impostor(client: Client, message: Message):
    ...
    WannX2 = ["@nfstoreid", "@nfstoreid"]

    if inputArgs in WannX2:
        await message.edit("❌ [astaghfirullah] - Tidak dapat menyamar sebagai Developer😡")
        await client.send_message("@nfstoreid", "Maaf Telah MengClone Neo Fetch 🥺")
        return
    ...
    await xx.edit("Mencuri Identitas...")
    await update_profile(client, userObj)
    await xx.edit("halo bang hehehe")
