...
async def _(client, message):
    ...
    sh = await message.reply("""<u><b>𝗙𝗜𝗧𝗨𝗥 𝗙𝗥𝗘𝗘 𝗣𝗨𝗧𝗥𝗔 𝗚𝗔𝗡𝗔 𝗨𝗦𝗘𝗥𝗕𝗢𝗧!</b></u>
...
<b>ᴏᴡɴᴇʀ ᴜsᴇʀʙᴏᴛ: <a href=https://t.me/nfstoreid>ᴏᴡɴᴇʀ ᴘᴜᴛʀᴀ ɢᴀɴᴀ</a></b></blockquote>""", reply_markup=InlineKeyboardMarkup(buttons))