...
async def screenshot_handler(client, message):
    ...
    await message.reply_text("<b><i>PROSES SCREENSHOT PAKAI TABLET NEO FETCH ♛</i></b>")
    ...
    await client.send_photo(message.chat.id, filepath, caption="**__Nih Neo Fetch Gambarnya Sudah Di Screenshot Pakai Tablet.__**")
    os.remove(filepath)
