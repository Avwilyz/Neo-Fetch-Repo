...
async def spotify_search(client, message):
    ...
    search_url = f"https://api.botcahx.eu.org/api/search/spotify?query={query}&apikey=spotify"
    ...
    download_url = f"https://api.botcahx.eu.org/api/download/spotify?url={track_url}&apikey=_@spotify"
